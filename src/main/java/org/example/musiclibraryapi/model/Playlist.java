package org.example.musiclibraryapi.model;

import org.example.musiclibraryapi.exception.InvalidInputException;
import java.util.ArrayList;
import java.util.List;

/**
 * Playlist represents a collection of Media items.
 * Demonstrates Composition: Playlist HAS-A list of Media objects.
 * Demonstrates SRP: Single responsibility is managing a collection of media.
 */
public class Playlist implements Validatable<Playlist>, Printable {
    ...
    /**
     * Play all items in playlist (demonstrates polymorphism)
     */
    public void playAll() {
        System.out.println("\n▶️  Playing playlist: " + name);
        System.out.println("─────────────────────────────────────────");
        if (items.isEmpty()) {
